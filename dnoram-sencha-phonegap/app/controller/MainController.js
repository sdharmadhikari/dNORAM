...
Ext.define('MyApp.controller.MainController', {
    ...
    onManageTaskButtonTap: function(button, e, eOpts) {
        console.log('1');
    ...
    onAddTaskButton: function(button, e, eOpts) {
        console.log('2');
        var now = new Date();
    ...
    onSaveTaskNavButtonTap: function(button, e, eOpts) {
        console.log('3');
    ...
    onWhatCanIDoNowButtonTap: function(image, e, eOpts) {
        console.log('4');
        console.log('clicked whatcanidonow');
        this.getAvailableTimePicker().setHidden(false);
    },

    onAvailableTimePickerChange: function(picker, value, eOpts) {
    ...
    onManageTasksListIItemTap: function(dataview, index, target, record, e, eOpts) {
    ...
    onTaskListItemSwipe: function(dataview, index, target, record, e, eOpts) {
    ...
    onMapItButtonTap: function(button, e, eOpts) {
