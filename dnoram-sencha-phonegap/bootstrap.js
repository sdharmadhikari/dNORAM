...
Ext.ClassManager.addNameAlternateMappings({
  ...
  "MyApp.model.Duser": [],
  "MyApp.model.LocalUser": [],
  "MyApp.model.Task": [],
  "MyApp.store.AddressTypeStore": [],
  "MyApp.store.ResultStore": [],
  "MyApp.store.TasksStore": [],
  "MyApp.view.AddTaskForm": [],
  "MyApp.view.Main": [],
  "MyApp.view.MainApplicationView": [],
  "MyApp.view.ManageTaskList": [],
  "MyApp.view.MapPanel": [],
  "MyApp.view.MyContainer": [],
  "MyApp.view.MyContainer1": [],
  "MyApp.view.MyImage": [],
  "MyApp.view.MyNavigationView": [],
  "MyApp.view.TaskResultList": []
});
Ext.ClassManager.addNameAliasMappings({
  ...
  "MyApp.view.AddTaskForm": [
    "widget.addTaskFormAlias"
  ],
  "MyApp.view.Main": [
    "widget.main"
  ],
  "MyApp.view.MainApplicationView": [
    "widget.mainApplicationView"
  ],
  "MyApp.view.ManageTaskList": [
    "widget.manageTaskListAlias"
  ],
  "MyApp.view.MapPanel": [
    "widget.mapPanel"
  ],
