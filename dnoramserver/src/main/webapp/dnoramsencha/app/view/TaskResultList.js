...
Ext.define('MyApp.view.TaskResultList', {
    ...
    config: {
        ...
        itemTpl: [
            ...
            '                <img src="resources/images/speedometer1.png" width="12px" height="12px" /> {drivingDistance}mi &nbsp;&nbsp;&nbsp;',
            '                <img src="resources/images/time.png" width="12px" height="12px" /> {drivingTime}m',
            '            <tpl else>',
            '                Current location',
            '            </tpl>',
            '         </div>',
